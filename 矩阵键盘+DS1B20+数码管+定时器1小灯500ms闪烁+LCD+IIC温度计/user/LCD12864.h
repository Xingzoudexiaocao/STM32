#include "GPIOx.h"
	...
	*/
/*#define---------------------------------------------------------------------*/
#define CLK_1 	PAout(6)=1	//PC3输出高电平	E
#define CLK_0 	PAout(6)=0	//PC3输出低电平

#define SID_1 	PAout(7)=1	//PC4输出高电平	RW
#define SID_0 	PAout(7)=0	//PC4输出低电平

#define CS_1 		PAout(8)=1	//PC6输出高电平	RS
#define CS_0 		PAout(8)=0	//PC6输出低电平

#define PSB_1 	PAout(9)=1	//PC7输出高电平	PSB
#define PSB_0 	PAout(9)=0	//PC7输出低电平
/* Definitions ---------------------------------------------------------------*/
